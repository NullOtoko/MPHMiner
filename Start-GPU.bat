...
@set "command=& .\multipoolminer.ps1 -Wallet 3A4EaCvfFXvDruCZB2u75rajzogANKXmDC -UserName RoyalTechnology -WorkerName multipoolminer -Region us -Currency btc,usd -DeviceName amd,nvidia -PoolName miningpoolhub,miningpoolhubcoins -Algorithm cryptonightv7,cryptonightheavy,ethash,ethash2gb,ethash3gb,equihash,lyra2re2,lyra2z,neoscrypt,skein -Donate 24 -Watchdog -MinerStatusURL https://multipoolminer.io/monitor/miner.php -SwitchingPrevention 2"
